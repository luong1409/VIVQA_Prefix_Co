...
from transformers import BertConfig, PhobertTokenizer, RobertaConfig
...
from model.configuration_mplug import (MPlugConfig)
# from mvit import MViTv2, MViTv2_Base_config
from model.constant import ModelFile
...
class MPlugForImageCaption(MPlug):
    ...
    def forward(self,
        ...
        image_output, question_output = fusion_output
        question_output = torch.cat([image_output, question_output], 1)
        merge_text_attention = torch.cat([image_atts, prefix.attention_mask], 1)
        
        answer_targets = decoder_input.input_ids.masked_fill(decoder_input.input_ids == self.tokenizer.pad_token_id, -100)
